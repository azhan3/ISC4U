...
let quizData = {
    "Images/sprite1.png": {
        question: ["Which of the following is a negative impact of technology on human health?", "Which of the following effects on the environment are caused by technologies", "What is a positive impact of technology", "How has technology being used in resource management helped the environment", "What is a negative impact of e-waste on the environment?"],
        answers: [["a) Increased physical activity", "b) Eye strain and headaches", "c) Improved sleep patterns", "d) Increased social interactions"], ["a) Air and water pollution", "b) Global warming", "c) Electronic waste", "d) All of the above"], ["a) Medical advancements", "b) Pollution", "c) Mental health issues", "d) False information"], ["a) It has led to more E-waste being produced", "b) It has developed more efficient farming practices", "c) It has led to more deforestation", "d) Better algorithms for social media"], ["a) It increases biodiversity", "b) It helps reduce greenhouse gas emissions", "c) It can lead to soil and water contamination", "d) It promotes healthy ecosystems"]],
        correctAnswer: [1, 3, 0, 1, 2]
    },
    "Images/sprite2.png": {
        question: ["Which of the following is a way to reduce the negative impact of technology on human health?", "What is a way to reduce the negative impact of technology on the environment?", "What is a positive impact of technology on the environment?", "How can we reduce the negative impact of e-waste on the environment?"],
        answers: [["a) Taking breaks from screen time", "b) Using technology in moderation", "c) Both a and b", "d) None of the above"], ["a) Recycling electronic waste", "b) Limiting the use of non-renewable energy sources", "c) Using energy-efficient technology", "d) All of the above"], ["a) More efficient resource management", "b) Increased air and water pollution", "c) Deforestation", "d) None of the above"], ["a) Landfills should be used to dispose of e-waste", "b) E-waste should be exported to other countries for disposal", "c) E-waste should be recycled", "d) All of the above"]],
